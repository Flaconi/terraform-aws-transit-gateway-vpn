...
| <a name="input_ike_versions"></a> [ike\_versions](#input\_ike\_versions) | List of IKE versions supported by the VPN tunnels. Allowed values: v1, v2. Applied to both Tunnel 1 and Tunnel 2. | `list(string)` | `null` | no |
...
| <a name="input_phase1_dh_group_numbers"></a> [phase1\_dh\_group\_numbers](#input\_phase1\_dh\_group\_numbers) | List of DH group numbers for phase 1 of the VPN tunnels. Applied to both Tunnel 1 and Tunnel 2. See aws\_vpn\_connection documentation for valid values. | `list(number)` | `null` | no |
| <a name="input_phase1_encryption_algorithms"></a> [phase1\_encryption\_algorithms](#input\_phase1\_encryption\_algorithms) | List of encryption algorithms for phase 1 of the VPN tunnels. Applied to both Tunnel 1 and Tunnel 2. See aws\_vpn\_connection documentation for valid values. | `list(string)` | `null` | no |
| <a name="input_phase1_integrity_algorithms"></a> [phase1\_integrity\_algorithms](#input\_phase1\_integrity\_algorithms) | List of integrity algorithms for phase 1 of the VPN tunnels. Applied to both Tunnel 1 and Tunnel 2. See aws\_vpn\_connection documentation for valid values. | `list(string)` | `null` | no |
| <a name="input_phase2_dh_group_numbers"></a> [phase2\_dh\_group\_numbers](#input\_phase2\_dh\_group\_numbers) | List of DH group numbers for phase 2 of the VPN tunnels. Applied to both Tunnel 1 and Tunnel 2. See aws\_vpn\_connection documentation for valid values. | `list(number)` | `null` | no |
| <a name="input_phase2_encryption_algorithms"></a> [phase2\_encryption\_algorithms](#input\_phase2\_encryption\_algorithms) | List of encryption algorithms for phase 2 of the VPN tunnels. Applied to both Tunnel 1 and Tunnel 2. See aws\_vpn\_connection documentation for valid values. | `list(string)` | `null` | no |
| <a name="input_phase2_integrity_algorithms"></a> [phase2\_integrity\_algorithms](#input\_phase2\_integrity\_algorithms) | List of integrity algorithms for phase 2 of the VPN tunnels. Applied to both Tunnel 1 and Tunnel 2. See aws\_vpn\_connection documentation for valid values. | `list(string)` | `null` | no |
